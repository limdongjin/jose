...
- **진행 상황:** `encode`, `decode`, `verify` 기본 구현 완료(HS256 기준).
...
1. HMAC 확장(HS384/HS512) 및 알고리즘 옵션 정리
2. 키 파싱(JWK/PEM) 로딩 유틸 추가
3. 공개키 알고리즘(RSA/ECDSA) 구현
4. 표준 클레임(`iss`, `aud`, `sub`, `jti`) 검증 추가
5. 테스트 스캐폴딩 및 벡터 추가
